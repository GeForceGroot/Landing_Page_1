                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 aos-init" id='setValue' data-aos="zoom-out" data-aos-duration="1400">
                                        <div className="row immigrationarea">
                                            ...
                                            <div className='col-10'>
                                                <p className="font-15 font-outfit lineh-16 weight-600 color ts" id='changeColor'><span className='giveMarg'>7-layer security tool for in-cloud storage
                                                </span></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 aos-init" id='setValue' data-aos="zoom-out" data-aos-duration="800">
                                        <div className="row immigrationarea">
                                            ...
                                            <div className='col-10'>
                                                <p className="font-15 font-outfit lineh-16 weight-600 color ts" id='changeColor'><span className='giveMarg'>Leverage costly premium Al technologies
                                                </span></p>
                                            </div>
                                        </div>
                                    </div>
