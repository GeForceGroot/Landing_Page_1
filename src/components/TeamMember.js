                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="team-detailsimg">
                                <img data-aos="zoom-in" data-aos-duration="1200" src={img} style={{borderRadius:'250px 250px 0 0', boxShadow: '0 15px 25px rgba(0, 0, 0, 0.2), 0 5px 10px rgba(0, 0, 0, 0.2)'}} width={'450px'} height={'450px'} alt=""/>
                            </div>
                        </div>
                        <div class="col-lg-6" style={{textAlign:'start', paddingTop:'50px'}}>
                            ...
                            <span class="font-16 font-outfit weight-500 lineh-16 color36 d-inline-block consultingspan margin-b20" data-aos="fade-right" data-aos-duration="1200">Team Members</span>
                                ...
                                <button data-aos="fade-right" data-aos-duration="1200" id="btnContact"><span>Get In Touch</span><i className="fa-solid fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
