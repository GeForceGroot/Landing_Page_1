                    ...
                    <div className="row align-items-center" id='temaCol'>
                        <div className="col-lg-6">
                            <div className="team-detailsimg">
                                <img id='kaushikImg' data-aos="zoom-in" data-aos-duration="1200" src={img} style={{borderRadius:'15px', boxShadow: '0 15px 25px rgba(0, 0, 0, 0.2), 0 5px 10px rgba(0, 0, 0, 0.2)'}} alt=""/>
                            </div>
                        </div>
                        <div className="col-lg-6" style={{textAlign:'start', paddingTop:'50px'}}>
                            <div className="team-detailsarea">
                            <span className="font-16 font-outfit weight-500 lineh-16 color36 d-inline-block consultingspan margin-b20" data-aos="fade-right" data-aos-duration="1200">Team Members</span>
