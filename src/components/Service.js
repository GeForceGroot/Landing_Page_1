          ...
          <div className="row align-items-centers">
            <div className="col-lg-6" style={{ marginTop: '-50px' }}>
              <div className="works5-sectino">
                ...
                <p style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)', fontSize: '100px' }} className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">Q</p>
                <p style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)', fontSize: '100px', marginTop: "70px" }} className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">U</p>
                <p style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)', fontSize: '100px', marginTop: '70px' }} className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">I</p>
                <p style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)', fontSize: '100px', marginTop: '70px' }} className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">C</p>
                <p style={{ textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)', fontSize: '100px', marginTop: '70px' }} className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1200">K</p>
                {/* <p className="font-outfit font-16 lineh-26 weight-400 color38 margin-b20" style={{ marginTop: '25px' }}>Quick Accounting is developed and works around its core values which supports the achievement of its mission.
                ...
                {/* <p className="font-outfit font-16 lineh-26 weight-400 color38 margin-b24">Streamline your operations to boost efficiency and reduce costs. Our consultants will identify bottlenecks, optimize processes, and recommend technologies that  transform  business operations.</p> */}
              </div>
            </div>
            <div className="col-lg-6">
              <div className="works-servicearea margin-b30 equel aos-init aos-animate" id='setColor' data-aos="fade-right" data-aos-duration="1000">
              ...
              <div className="works-servicearea margin-b30 aos-init aos-animate" id='setColor' data-aos="fade-right" data-aos-duration="1200">
                <div className="worksicons5">
                ...
                <div className="workstext">
                  ...
                  <p className="font-outfit font-16 weight-400 lineh-26 color38 ts">We believe in doing things differently. Our years of experience makes us know the importance of unique services. We experiment with new things each day so you can havequick information.</p>
                </div>
              </div>


              <div className="works-servicearea aos-init" data-aos="fade-right" id='setColor' data-aos-duration="1400">
                <div className="worksicons5">
              ...
              </div><div className="works-servicearea aos-init" id='setColor' data-aos="fade-right" data-aos-duration="1400">
                <div className="worksicons5">
              ...
              <div className="works-servicearea aos-init" id='setColor' data-aos="fade-right" data-aos-duration="1400">
                <div className="worksicons5">
