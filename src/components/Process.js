                    ...
                    <div class="row align-items-center" style={{textAlign:'start'}}>
                        <div class="col-lg-5 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                            <div class="company6text6">
                                <span class="trusts font-16 lineh-16 font-nunito weight-600 color-h5 d-inline-block">In-House Proven Process</span>
                                ...
                                <p class="font-nunito font16 weight-500 color-nuni lineh-26 margin-b30" style={{fontFamily:'inherit'}}>Our professionals have developed a quick way to meet your needs, over the years as,</p>
                            </div>
                                ...
                                <div class="accordion accordian4" id="accordionExample">
                                    ...
                                    <div class="accordion-item aos-init" data-aos="fade-right" data-aos-duration="1400">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p class="font-nunito font-16 lineh-26 weight-500 color-30 ">We review your past data and records, existing records, external views and opinions for better understanding.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item aos-init" data-aos="fade-right" data-aos-duration="1600">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p class="font-nunito font-16 lineh-26 weight-500 color-30 ">After technical resource organising, we work with you to develop the best processes, delivery paths, and tools and dedicate employees and rates to meet your needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item aos-init" data-aos="fade-right" data-aos-duration="1800">
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p class="font-nunito font-16 lineh-26 weight-500 color-30 ">Active implementation is done backed up by continuous monitoring and real-time communication. Changes are made based on this.</p>
                                            </div>
                                        </div>
                                    </div><div class="accordion-item aos-init" data-aos="fade-right" data-aos-duration="1800">
                                        <h2 class="accordion-header">
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                <p class="font-nunito font-16 lineh-26 weight-500 color-30 ">Our backend team is always ready to help you. We are just a call or mail away. Fill out the form below and our executive will connect you.</p>
                                            </div>
                                        </div>
                                    </div>
