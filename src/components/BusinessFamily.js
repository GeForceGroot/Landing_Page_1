    ...
    <>
      <div className="container" style={{marginTop:'25px'}}>
        <div className="row align-items-center" id="rowReverse">
          ...
          <div className="col-lg-6" id="centerData">
            <div className="abou-5textarea5">
              ...
              <h2 className="font-outfit font-44 lineh-52 color37 weight-600 margin-b20" style={{ marginTop: '10px', textShadow: '4px 4px 5px rgba(0, 0, 0, 0.3)', color: 'rgba(32, 64, 99, 0.8)' }}>Join Our Community</h2>
