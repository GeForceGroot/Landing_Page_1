                    ...
                    <div className="row" style={{textAlign:'start'}}>
                        <div className="col-lg-6 aos-init" id='setExp' data-aos="zoom-out" data-aos-duration="800">
                            <div className="servicebrne8area margin-b30">
                                ...
                                <a href="servicemiddle.html" className="font-20 lineh-20 weight-600 color39 d-inline-block margin-b14 font-lora ts">Affordable Rates</a>
                        ...
                        <div className="col-lg-6 aos-init" id='setExp' data-aos="zoom-out" data-aos-duration="1200">
                            <div className="servicebrne8area margin-b30">
                                ...
                                <a href="servicemiddle.html" className="font-20 lineh-20 weight-600 color39 d-inline-block margin-b14 font-lora ts">Experience</a>
                        ...
                        <div className="col-lg-6 aos-init" id='setExp' data-aos="zoom-out" data-aos-duration="1400">
                            <div className="servicebrne8area margin-b30">
                                ...
                                <a href="servicemiddle.html" className="font-20 lineh-20 weight-600 color39 d-inline-block margin-b14 font-lora ts">Leveraging Technology</a>
